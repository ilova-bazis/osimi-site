...
const homeContent: Record<Locale, HomePageContent> = {
  en: {
    ...
    hero: {
      ...
      taglineLines: ['Scholar, Humanist, Science Organizer,', 'and Public Figure'],
      intro:
    ...
    bioPreview: {
      ...
      details: [
        'Muhammad Saifiddinovich Asimov received his qualification as a physicist from the Physics and Mathematics Faculty of Uzbek State University (1937-1941). He served with distinction in the Second World War, receiving the Order of the Patriotic War (1st degree) and multiple military honors.',
      ...
      milestones: [
        {
          era: 'Origin',
          yearLines: ['1920'],
          description: 'Born in Khujand, Tajikistan, on August 25',
        },
        {
          era: 'Institution Building',
          yearLines: ['1956'],
          description: 'Appointed first rector of the Tajik State Polytechnic Institute',
        },
        {
          era: 'Scientific Leadership',
          yearLines: ['1965-1988'],
          compactYear: true,
          description: 'President of the Academy of Sciences of Tajikistan for 23 years',
        },
        {
    ...
    works: {
      ...
      body:
        "Muhammad Osimi's intellectual work ranged across philosophy of science, history of science, cultural heritage, and the study of Central Asian civilization. He wrote, edited, translated, and led major scholarly efforts that helped preserve and interpret the intellectual heritage of the region.",
      tags: [
    ...
    documentary: {
      ...
      meta:
        'Narrated by Oscar-nominated Ali MacGraw · Filmed in Tajikistan, India, France, Spain, Russia, and the United States',
      ...
      quotes: [
        {
          ...
          theme: 'On Generosity',
          originalText: "The worth of a person's thoughts is a measure of his or her own generosity.",
        },
        {
          text: 'Children must be respected and their self-worth should not be damaged.',
          theme: 'On Children',
          originalText: 'Children must be respected and their self-worth should not be damaged.',
        },
        {
          text: 'Men of culture are the Hosts of History, men of politics are the Guests.',
          theme: 'On History',
          originalText: 'Men of culture are the Hosts of History, men of politics are the Guests.',
        },
      ],
    },
    archive: {
  ...
  tg: {
    ...
    hero: {
      ...
      taglineLines: ['Олим, инсондӯст, ташкилотчии илм,', 'ва ходими ҷамъиятӣ'],
      intro:
    ...
    quoteBand: {
      textLines: ['Мардуми фарҳанг мизбонони таъриханд,', 'мардуми сиёсат меҳмонони он.'],
    ...
    bioPreview: {
      ...
      details: [
        'Муҳаммад Сайфиддинович Осимӣ таҳсили олии худро дар факултаи физика ва математикаи Донишгоҳи давлатии ӯзбекистон ба номи А. Навоӣ (1937-1941) анҷом дода, ихтисоси физикаро гирифт. Ӯ дар Ҷанги Бузурги Ватанӣ бо шараф хидмат карда, бо орден ва медалҳои ҷангӣ сарфароз гардид.',
    ...
    legacy: {
      ...
      milestones: [
        { era: 'Оғоз', yearLines: ['1920'], description: '25 август дар шаҳри Хуҷанд ба дунё омад' },
        {
          era: 'Бунёди муассисаҳо',
          yearLines: ['1956'],
          description: 'Аввалин ректори Донишкадаи давлатии политехникии Тоҷикистон таъин шуд',
        },
        {
          era: 'Роҳбарии илм',
          yearLines: ['1965-1988'],
          compactYear: true,
          description: '23 сол президенти Академияи илмҳои Тоҷикистон буд',
        },
        {
    ...
    works: {
      ...
      body:
        'Кори зеҳнии Муҳаммад Осимӣ масъалаҳои фалсафаи илм, таърихи илм, мероси фарҳангӣ ва омӯзиши тамаддуни Осиёи Марказиро фаро мегирифт. Ӯ менавишт, таҳрир мекард, тарҷума менамуд ва ба иқдомҳои бузурги илмӣ роҳбарӣ мекард, ки барои ҳифз ва тафсири мероси зеҳнии минтақа мусоидат намуданд.',
      tags: ['Фалсафаи илм', 'Таърихи тамаддун', 'Мероси фарҳангӣ', 'Маориф', 'Лоиҳаҳои ЮНЕСКО', 'Адабиёти форсӣ-тоҷикӣ'],
      cta: 'Осор ва андешаҳоро бинед',
      pullLabel: 'Аз навиштаҳои ӯ',
      pullQuote: 'Арзиши андешаҳои инсон меъёри саховатмандии худи ӯст.',
      attribution: 'Муҳаммад Осимӣ',
      note:
        'Осори ӯ ба забонҳои русӣ, англисӣ, олмонӣ, форсӣ ва арабӣ нашр шудаанд. Аз ҷумлаи корҳои муҳимаш «Материя ва манзараи физикии олам» (1966), «Мафҳуми материя ва масъалаи воқеияти физикӣ» (1970) ва «Энсиклопедияи Советии Тоҷик» дар ҳашт ҷилд (1978) мебошанд.',
    },
    documentary: {
      label: 'Филм',
      title: 'Осимӣ',
      subtitle: 'Филми мустанад дар бораи зиндагие, ки миллатро тағйир дод',
      paragraphs: [
      ...
      meta:
        'Бо овози Али Макгроу · Наворбардорӣ дар Тоҷикистон, Ҳиндустон, Фаронса, Испания, Русия ва Иёлоти Муттаҳида',
      ...
      quotes: [
        {
          ...
          originalText: 'Арзиши андешаҳои инсон меъёри саховатмандии худи ӯст.',
        },
        {
          text: 'Кӯдаконро бояд эҳтиром кард ва шаъну эътибори онҳоро набояд кост.',
          theme: 'Дар бораи кӯдакон',
          originalText: 'Кӯдаконро бояд эҳтиром кард ва шаъну эътибори онҳоро набояд кост.',
        },
        {
          text: 'Мардуми фарҳанг мизбонони таъриханд, мардуми сиёсат меҳмонони он.',
          theme: 'Дар бораи таърих',
          originalText: 'Мардуми фарҳанг мизбонони таъриханд, мардуми сиёсат меҳмонони он.',
        },
      ],
    },
    archive: {
      ...
      body:
        'Ин сомона бахше аз талоши пайваста барои ҳифзи ҳаёт, андеша, навиштаҳо ва хотираи ҷамъиятии Муҳаммад Осимӣ барои наслҳои оянда мебошад. Тавассути аксҳо, санадҳо, нашрияҳо, филм ва дигар маводи таърихӣ, бойгонӣ мекӯшад мероси ӯро дастрас, омӯхташаванда ва зинда нигоҳ дорад.',
      cta: 'Ба бойгонӣ гузаред',
    },
  },
  ru: {
    metadata: {
      title: 'Мухаммад Осими - ученый, гуманист, организатор науки и общественный деятель',
      description:
    ...
    hero: {
      ...
      taglineLines: ['Ученый, гуманист, организатор науки,', 'и общественный деятель'],
      intro:
    ...
    quoteBand: {
      textLines: ['Люди культуры - хозяева истории,', 'люди политики - ее гости.'],
    ...
    bioPreview: {
      ...
      details: [
        'Мухаммад Сайфиддинович Асимов получил квалификацию физика на физико-математическом факультете Узбекского государственного университета имени А. Навои (1937-1941). Во время Второй мировой войны он служил с отличием и был награжден орденом Отечественной войны I степени и рядом боевых медалей.',
    ...
    legacy: {
      ...
      milestones: [
        { era: 'Начало', yearLines: ['1920'], description: 'Родился 25 августа в городе Худжанде' },
        {
          era: 'Создание институтов',
          yearLines: ['1956'],
          description: 'Назначен первым ректором Таджикского политехнического института',
        },
        {
          era: 'Научное руководство',
          yearLines: ['1965-1988'],
          compactYear: true,
          description: '23 года возглавлял Академию наук Таджикистана',
        },
        {
    ...
    works: {
      ...
      body:
        'Интеллектуальная работа Мухаммада Осими охватывала философию науки, историю науки, культурное наследие и изучение цивилизации Центральной Азии. Он писал, редактировал, переводил и возглавлял крупные научные инициативы, помогавшие сохранять и осмыслять интеллектуальное наследие региона.',
      tags: ['Философия науки', 'История цивилизации', 'Культурное наследие', 'Образование', 'Проекты ЮНЕСКО', 'Персидско-таджикская литература'],
      cta: 'Смотреть труды и идеи',
      pullLabel: 'Из его работ',
      pullQuote: 'Ценность мыслей человека есть мера его собственной щедрости.',
      attribution: 'Мухаммад Осими',
      note:
        'Его книги выходили на русском, английском, немецком, фарси и арабском языках. Среди важнейших работ - «Материя и физическая картина мира» (1966), «Понятие материи и проблема физической реальности» (1970) и восьмитомная «Таджикская советская энциклопедия» (1978).',
    },
    documentary: {
      label: 'Фильм',
      title: 'Осими',
      ...
      quotes: [
        {
          ...
          theme: 'О щедрости',
          originalText: 'Ценность мыслей человека есть мера его собственной щедрости.',
        },
        {
        ...
        },
        {
          ...
          theme: 'Об истории',
          originalText: 'Люди культуры - хозяева истории, люди политики - ее гости.',
        },
      ],
    },
    archive: {
      ...
      title: 'Живой архив',
      body:
        'Этот сайт является частью продолжающейся работы по сохранению жизни, мысли, текстов и общественной памяти о Мухаммаде Осими для будущих поколений. Через фотографии, документы, публикации, фильм и исторические материалы архив стремится сохранять его наследие доступным, изучаемым и живым.',
      cta: 'Перейти в архив',
    },
  },
}
