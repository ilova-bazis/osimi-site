    ...
    sections: [
        {
            ...
            paragraphs: [
                ...
                "Family reminiscences preserved in the archive describe an early life marked by hardship as well as discipline: he lost his mother in infancy, spent long periods in the countryside with his father during agricultural work, and retained a lifelong respect for rural labor. Relatives also recalled the formative influence of his elder brother, who opened for him the world of books and science and encouraged him toward the study of physics.",
        ...
        },
        {
            ...
            paragraphs: [
                "In 1941, immediately upon completing his university studies, Muhammad Asimov was called into military service in the Soviet Army. During training he passed through artillery instruction connected to the wartime evacuation of the Kyiv artillery school near Saratov, and fellow memoirists later recalled that even there he was already acting like a teacher: translating difficult lessons from Russian into Tajik for other recruits and reading books aloud to them whenever time allowed.",
                "He served for five years on the Eastern Front of the Second World War, including on the Leningrad Front — one of the most brutal theaters of the conflict. He fought in artillery and, by 1944, held battery command responsibilities. During the fighting around Leningrad he lost his brother, Zainiddin Asimov, who had served in the same military unit — a loss that remained one of the defining tragedies of his life.",
                'He was awarded the medal "For the Defense of Leningrad" in February 1944 and the medal "For Victory over Germany in the Great Patriotic War 1941–1945" in 1945, and was also decorated with the Order of the Patriotic War (1st degree). In the spring of 1944 he was seriously wounded during heavy combat near Leningrad; after treatment, he returned to the front by his own request. Over the following decades he received multiple commemorative military honors, including another Order of the Patriotic War (1st degree) in 1985 and the anniversary medal "50 Years of Victory" in 1995.',
                "He joined the Communist Party of the Soviet Union in 1945, while still in military service. The war years shaped his worldview profoundly — the experience of destruction, frontline discipline, and personal sacrifice deepened his commitment to education, culture, and the building of a peaceful, knowledge-based society.",
            ],
        },
        {
            id: "academic-formation",
        ...
        },
        {
            ...
            callout: {
                text: "Twenty-three years at the helm of the Academy of Sciences — the longest presidency in its history — an era that saw the founding of major institutions and the publication of the eight-volume Tajik Soviet Encyclopedia.",
            },
            image: {
