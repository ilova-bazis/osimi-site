...
const worksContent: Record<Locale, WorksPageContent> = {
    ...
    selected: {
      ...
      items: [
        ...
        },
        {
          ...
          year: '1978',
          note: 'A major eight-volume editorial project, completed in 1978, demonstrating his role in building public knowledge.',
        },
        {
  ...
  tg: {
    ...
    selected: {
      ...
      items: [
        {
          title: 'Материя ва тасвири физикии ҷаҳон',
          year: '1966',
        ...
        {
          title: 'Пайдоиш ва рушди тафаккури фалсафӣ',
          year: '1970',
        ...
        },
        {
          ...
          year: '1978',
          note: 'Лоиҳаи бузурги таҳририи ҳаштҷилда, ки соли 1978 ба анҷом расид ва нақши ӯро дар бунёди дониши ҷамъиятӣ нишон медиҳад.',
        },
        {
    ...
    selected: {
      ...
      items: [
        ...
        },
        {
          ...
          year: '1978',
          note: 'Крупный восьмитомный редакторский проект, завершенный в 1978 году и показывающий его роль в строительстве общественного знания.',
        },
        {
